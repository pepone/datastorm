...
main(int argc, char* argv[])
{
    try
    {
        ...
        //
        // Setup partial update updaters. The updater is responsible for updating
        // the element value when a partial update is received. Updaters must be set
        // on the topic from both the reader and writer.
        //
        ...
        {
            //
            // Create a reader that connects to all the keys but doesn't receive any
            // samples (we use the `_event' predefined sample filter with an empty set
            // of sample events to discard events on the writer).
            //
            ...
            //
            // Get the set of stocks connected with the any reader and display their
            // ticker.
            //
            std::promise<void> p;
