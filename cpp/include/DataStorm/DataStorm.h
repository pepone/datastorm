...
namespace DataStorm
{
     ...
     *
     * The Sample template provides access to the key, value as well as additional
     * information such as the event, timestamp, update tag. Samples are generated
     * and published by writers and received by readers.
     *
    ...
    public:
         ...
         * not explicitly specified with the Sample template parameters.
         */
         ...
         * available. It's the case if the sample event is Remove where this method
         ...
         *
         * The origin of the sample identifies uniquely on the node the writer that
         * created the sample. It's the name of the writer if a name was explicitly
         * provided on creation of the writer. Otherwise, if no name was provided, an
         * unique identifier is generated by DataStorm.
         *
         ...
         *
         * This session identifier can be used to retrieve the Ice connection with the
         * node.
         *
    ...
    /**
     * Convert the given sample to a string and add it to the stream. The
     * implementation outputs the sample value.
     *
     * @param os The output stream
    ...
    public:
        ...
        /**
         * Destruct the reader. The destruction of the reader disconnects the reader
         * from the writers.
         */
        ~Reader();
        ...
        /**
         * Wait for given number of writers to be online. The node shutdown will cause
         * this method to raise NodeShutdownException.
         *
        ...
        /**
         * Wait for readers to be offline. The node shutdown will cause this method to
        ...
        /**
         * Wait for given number of unread samples to be available. The node shutdown
        ...
        /**
         * Returns the next unread sample. The node shutdown will cause this method to
         * raise NodeShutdownException.
         *
         ...
         * @param update The function to call when a key is added or removed from the
         *set.
         **/
         ...
         *
         * The init callback is always called after this method returns to provide the
         *initial set of connected writers. The update callback is called when new
         *writers connect or disconnect.
         *
         * @param init The function to call with the initial set of connected writers.
         * @param update The function to call when a new writer connects or
         *disconnects.
         **/
         ...
         *
         * The init callback is always called after this method returns to provide the
         *initial set of unread samples. The queue callback is called when a new
         *sample is received.
         *
    ...
    public:
        ...
        /**
         * Destruct the writer. The destruction of the writer disconnects the writer
         * from the readers.
         */
        ~Writer();
        ...
        /**
         * Wait for given number of readers to be online. The node shutdown will cause
         * this method to raise NodeShutdownException.
         *
        ...
        /**
         * Wait for readers to be offline.  The node shutdown this method to raise
         ...
         *
         * The init callback is always called after this method returns to provide the
         *initial set of connected readers. The update callback is called when new
         *readers connect or disconnect.
         *
         * @param init The function to call with the initial set of connected readers.
         * @param update The function to call when a new reader connects or
         *disconnects.
         **/
     ...
     * The Topic class.
     *
     * This class allows constructing reader and writer objects. It's also used to
     * setup filter and updater functions.
     *
     * @headerfile DataStorm/DataStorm.h
     */
    ...
    public:
        ...
        /**
         * Wait for given number of data writers to be online. The node shutdown will
        ...
        /**
         * Wait for given number of data readers to be online. The node shutdown will
         * cause this method to raise NodeShutdownException.
         *
        ...
        /**
         * Set a sample filter factory. The given factory function must return a
         * filter function that returns true if the sample matches the filter
    ...
    /**
     * Creates a key reader for the given topic and key. This helper method deduces
    ...
    /**
     * Creates a key reader for the given topic, key and sample filter. This helper
    ...
    /**
     * Creates a multi-key reader for the given topic. This helper method deduces
     * the topic Key, Value and UpdateTag types from the topic argument.
     *
    ...
    public:
        /**
         * Construct a new reader for the given key filter. The construction of the
         * reader connects the reader to writers whose key matches the key filter
         * criteria.
         *
        ...
        /**
         * Construct a new reader for the given key filter and sample filter criteria.
         * The construction of the reader connects the reader to writers whose key
         * matches the key filter criteria.
         *
         * If the key filter is not registered with the topic or the filter invalid,
         * std::invalid_argument is raised.
         *
    ...
    /**
     * Creates a new filtered reader for the given topic and key filter. This helper
     * method deduces the topic Key, Value and UpdateTag types from the topic
     * argument.
     *
     * @param topic The topic.
    ...
    /**
     * Creates a new filter reader for the given topic, key filter and sample
     * filter. This helper method deduces the topic Key, Value and UpdateTag types
     * from the topic argument.
     *
     * @param topic The topic.
     * @param keyFilter The key filter.
     * @param sampleFilter The sample filter.
    ...
    public:
        ...
        /**
         * Get a partial update generator function for the given partial update tag.
         * When called, the returned function generates a {@link PartialUpdate} sample
         * with the given partial update value.
         *
         * The UpdateValue template parameter must match the UpdateValue type used to
         * register the updater with the {@link Topic::setUpdater} method.
         *
    ...
    public:
        ...
        /**
         * Add the data element. This generates an {@link Add} sample with the given
         * value.
         *
         * @param key The key
         * @param value The data element value.
    ...
    /**
     * Creates a multi-key writer for the given topic and keys. This helper method
    ...
    /**
     * Creates an any-key writer for the given topic. This helper method deduces the
     * topic Key, Value and UpdateTag types from the topic argument.
     *
     * @param topic The topic.
     * @param name The optional writer name.
...
#    include <regex.h>
    ...
    struct RegexFilter<T, V, typename std::enable_if<DataStormI::is_streamable<V>::value>::type>
    {
        template<typename F> static void add(F factory)
        {
            factory->set("_regex", makeRegexFilter<T>()); // Only set the _regex filter
                                                          // if the value is streamable
        }
    };
